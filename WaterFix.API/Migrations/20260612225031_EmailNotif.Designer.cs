...
namespace WaterFix.API.Migrations
{
    ...
    [Migration("20260612225031_EmailNotif")]
    partial class EmailNotif
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WaterFix.API.Models.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WaterFix.API.Models.ChatMessage", b =>
                {
                    b.HasOne("WaterFix.API.Models.User", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WaterFix.API.Models.User", "Sender")
                        .WithMany()
